...
training <- read.csv("C:/Users/Sumit_Rohj/Downloads/pml-training.csv", na.strings=c("NA","#DIV/0!",""))
testing <- read.csv("C:/Users/Sumit_Rohj/Downloads/pml-testing.csv", na.strings=c("NA","#DIV/0!",""))
```
